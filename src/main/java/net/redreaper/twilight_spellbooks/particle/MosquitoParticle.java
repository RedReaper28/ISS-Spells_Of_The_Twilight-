...
public class MosquitoParticle extends TextureSheetParticle {
    ...
    public MosquitoParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
...
//        return (int) Mth.lerp(litTween, darkColor, litColor);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new MosquitoParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
