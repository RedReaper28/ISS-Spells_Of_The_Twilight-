...
public class ExanimatedFireParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    public ExanimatedFireParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public void tick() {
        ...
        if (this.random.nextFloat() <= .25f) {
            this.level.addParticle(ModParticleHelper.EXANIMATED_EMBERS, this.x, this.y, this.z, this.xd, this.yd, this.zd);
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new ExanimatedFireParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
