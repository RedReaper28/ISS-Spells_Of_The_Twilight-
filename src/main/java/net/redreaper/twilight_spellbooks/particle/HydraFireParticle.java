...
public class HydraFireParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    public HydraFireParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public void tick() {
        ...
        if (this.random.nextFloat() <= .25f) {
            this.level.addParticle(ModParticleHelper.HYDRA_EMBER_PARTICLE, this.x, this.y, this.z, this.xd, this.yd, this.zd);
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new HydraFireParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
