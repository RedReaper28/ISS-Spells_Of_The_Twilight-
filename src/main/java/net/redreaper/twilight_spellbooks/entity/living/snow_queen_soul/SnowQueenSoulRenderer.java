...
public class SnowQueenSoulRenderer extends EntityRenderer<SnowQueenSoulEntity> {
    ...
    private static final ResourceLocation CROWN_TEXTURE = TwilightSpellbooks.id("textures/entity/snow_crown.png");
    private final ModelPart body;
    private final ModelPart crownCube;

    public SnowQueenSoulRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(SnowQueenSoulEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        ...
        consumer = bufferSource.getBuffer(renderType(TEXTURE));
        renderOrb(poseStack, consumer, 1, noise, 1f, 30, 31, 140);
        consumer = bufferSource.getBuffer(renderType(TEXTURE));
        renderOrb(poseStack, consumer, 0.8f, noise, 1.5f, 30, 31, 140);
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull SnowQueenSoulEntity entity) {
        return TEXTURE;
    }
