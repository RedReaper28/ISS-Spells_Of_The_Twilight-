...
public class SummonedMinotaur extends Minotaur implements IMagicSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedMinotaur(EntityType entity, Level world) {
        super(entity, world);
        xpReward = 0;
    }

    public SummonedMinotaur(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_MINOTAUR.get(), level);
    }
    ...
    public void onUnSummon() {
        ...
        {
            MagicManager.spawnParticles(level(), TFParticleType.SNOW_GUARDIAN.get(),
                    getX(), getY(), getZ(),
                    25,
    ...
    public boolean doHurtTarget(Entity pEntity) {
        return Utils.doMeleeAttack(this, pEntity, ModSpells.SUMMON_MINOTAURS.get().getDamageSource(this, getSummoner()));
    }
