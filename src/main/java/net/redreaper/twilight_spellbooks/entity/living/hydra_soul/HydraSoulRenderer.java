...
public class HydraSoulRenderer extends EntityRenderer<HydraSoulEntity> {
    ...
    public HydraSoulRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(HydraSoulEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        ...
        consumer = bufferSource.getBuffer(renderType(TEXTURE));
            renderOrb(poseStack, consumer, 1, noise, 1f, 124, 0, 44);
        consumer = bufferSource.getBuffer(renderType(TEXTURE));
        renderOrb(poseStack, consumer, 0.8f, noise, 1.5f, 124, 0, 44);
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull HydraSoulEntity entity) {
        return TEXTURE;
    }
