...
public class SummonedDeathTome extends DeathTome implements IMagicSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedDeathTome(EntityType entity, Level world) {
        super(entity, world);
        xpReward = 0;
    }

    public SummonedDeathTome(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_DEATH_TOME.get(), level);
    }
    ...
    public boolean doHurtTarget(Entity pEntity) {
        return Utils.doMeleeAttack(this, pEntity, ModSpells.SUMMON_DEATH_TOME.get().getDamageSource(this, getSummoner()));
    }
