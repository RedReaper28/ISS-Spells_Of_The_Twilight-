...
public class UrGhastSoulRenderer extends EntityRenderer<UrGhastSoulEntity> {
    ...
    private static final ResourceLocation CROWN_TEXTURE = TwilightSpellbooks.id("textures/entity/none.png");
    private final ModelPart body;
    private final ModelPart crownCube;

    public UrGhastSoulRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(UrGhastSoulEntity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        poseStack.pushPose();
        ...
        consumer = bufferSource.getBuffer(renderType(TEXTURE));
            renderOrb(poseStack, consumer, 1, noise, 1f, 221, 0, 0);
        consumer = bufferSource.getBuffer(renderType(TEXTURE));
        renderOrb(poseStack, consumer, 0.8f, noise, 1.5f, 221, 0, 0);
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull UrGhastSoulEntity entity) {
        return TEXTURE;
    }
