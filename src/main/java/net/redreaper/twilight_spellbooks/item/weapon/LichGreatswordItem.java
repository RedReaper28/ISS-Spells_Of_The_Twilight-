...
public class LichGreatswordItem extends MagicSwordItem implements UniqueItem {
    ...
    public void initializeSpellContainer(ItemStack itemStack) {
        ...
        AffinityData.setAffinityData(itemStack, ModSpells.EXANIMATED_FIREBALL.get(), 1);
    }
    ...
    public class SpellEvents {
        ...
        public static void onModifySpellLevel(ModifySpellLevelEvent event) {
            ...
            if (caster != null) {
                if (event.getSpell() == ModSpells.EXANIMATED_FIREBALL.get()) {
                    ItemStack mainHand = caster.getMainHandItem();
                    ItemStack offHand = caster.getOffhandItem();
                    boolean usingKnives = mainHand.getItem() instanceof LichGreatswordItem || offHand.getItem() instanceof LichGreatswordItem;
                    if (usingKnives) {
                        event.addLevels(1);
                    }
