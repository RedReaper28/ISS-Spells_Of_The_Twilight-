...
public class CarminitePullSpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(TwilightSpellbooks.MOD_ID, "carminite_pull");
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        if (playerMagicData.isCasting() && playerMagicData.getCastingSpellId().equals(this.getSpellId())
            ...
            CarminiteTrapPullProjectile fireBreathProjectile = new CarminiteTrapPullProjectile(world, entity);
            fireBreathProjectile.strength = strength;
