...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SummonedMinotaur>> SUMMONED_MINOTAUR =
            ENTITIES.register("summoned_minotaur", () -> EntityType.Builder.<SummonedMinotaur>of(SummonedMinotaur::new, MobCategory.MONSTER).
                    sized(0.6F, 2.1F)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(TwilightSpellbooks.MOD_ID, "summoned_minotaur").toString()));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HydraPoisonField>> HYDRA_FIRE_FIELD =
            ENTITIES.register("hydra_fire_field", () -> EntityType.Builder.<HydraPoisonField>of(HydraPoisonField::new, MobCategory.MISC)
                    .sized(4f, 1.2f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(TwilightSpellbooks.MOD_ID, "hydra_fire_field").toString()));
